...
\caption{Transition location on the upper and lower surface at Airbus A340 operating conditions for various suction velocities when applied to the NLF optimized geometry with an additional suction location is added upstream with an extent of 3\%.}
...
In this paper, we present a framework for aerodynamic shape optimization incorporating HLFC through suction. The methodology was first validated against benchmark cases including flat-plate flow and NACA 64A010 airfoil experiments, demonstrating accurate prediction of laminar-to-turbulent transition and suction effects. Lift-constrained drag minimization was then performed for an infinite swept wing after which suction was applied at fixed locations upstream of the transition location at estimated Airbus A340 operating conditions, yielding 15\% drag reduction compared with a turbulent optimized geometry. The updated transition location was determined and suction was reapplied upstream of this location, yielding 19\% drag reduction compared to a turbulent optimized geometry. 
